...
#include "Infinite_ShooterCharacter.generated.h"

class UInputComponent;

UCLASS(config = Game)
class AInfinite_ShooterCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Projectile)
		TSubclassOf<class AInfinite_ShooterProjectile> ProjectileClass;
